...
extension ViewController: UITableViewDelegate {
    ...
    func showActionSheet(index: Int) {
        ...
        let delete = UIAlertAction(title: "DELETE", style: .default, handler: {_ in
            self.displayMessage(index: index)
        })
    ...
    func displayMessage(index: Int) {
        let myAlert = UIAlertController(title: "Alert", message: "Delete For Sure?", preferredStyle: UIAlertController.Style.alert)
